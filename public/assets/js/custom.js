...
function redirect(url) {
    ...
    if (window.confirm("Sādo pāti no u~ebu saito ni ridairekuto sa rete imasu. Sono u~ebusaito no naiyō ni tsuite wa sekinin o oi kanemasunode go ryōshō kudasai. Zokkō suru baai wa,[OK] o kurikku shimasu.")) {
